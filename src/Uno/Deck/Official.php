...
class Official extends \Erebot\Module\Uno\AbstractDeck
{
    protected $cards;
    protected $discarded;
    protected $firstCard;
    ...
    protected function chooseFirstCard()
    {
        ...
        $this->firstCard = reset($this->cards);
        while ($this->firstCard[0] === 'w') {
    ...
    {
        if (!count($this->cards)) {
            throw new \Erebot\Module\Uno\EmptyDeckException();
        }
